...
<body>
  ...
  <div class="leftcolumn">
    <div class="card" id="initiated">
      ...
      <a href="/bulletin/upcoming_events/{{ $event->id }}">See More >></a>
      @endforeach
              ...
              <h2>Latest News</h2>
                    <div class=\"data_feedback\"> 
                      ...
                      <img src="{{ URL::asset('images/Admin/Bulletin/News/'.$latestNews->thumbnailImage) }}" alt="">
                         ...
                         <p>Time Uploaded: {{ date('F j, Y, g:i a', strtotime($latestNews->created_at)) }} </p>                       @endforeach    
                 </div>
